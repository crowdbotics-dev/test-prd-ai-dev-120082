"""
Django settings for test_prd_ai_dev_120082 project.
...
ROOT_URLCONF = 'test_prd_ai_dev_120082.urls'
...
WSGI_APPLICATION = 'test_prd_ai_dev_120082.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_prd_ai_dev_120082 API",
    "DESCRIPTION": "API documentation for test_prd_ai_dev_120082 App",
    "VERSION": "v1",
}
